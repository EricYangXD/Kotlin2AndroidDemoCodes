...
class MapOfActivity : AppCompatActivity() {
    ...
    private var goodsMap: Map<String, String> = mapOf()
    // MutableMap是个可变映射，允许进行增加、修改、删除等操作
    private var goodsMutMap: MutableMap<String, String> = mutableMapOf()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_map_add.setOnClickListener {
            ...
            // 使用put方法逐个添加
            goodsMutMap["苹果"] = goodsA
            goodsMutMap["华为"] = goodsB
            goodsMutMap["小米"] = goodsC
            goodsMutMap["欧珀"] = goodsD
            goodsMutMap["步步高"] = goodsE
            goodsMutMap["魅族"] = goodsF
        ...
        btn_map_foreach.setOnClickListener {
            ...
            tv_map_result.text = "手机畅销榜包含以下${goodsMap.size}款手机：\n$desc"
