...
class RoundTextView @JvmOverloads constructor(context: Context, attrs: AttributeSet?=null, defStyle: Int=0) : android.support.v7.widget.AppCompatTextView(context, attrs, defStyle) {
    //控件只能重写onDraw方法
